...
while TIME_STEPS * iters < 1000000:
    ...
    model3.learn(total_timesteps = TIME_STEPS, reset_num_timesteps = False, tb_log_name = "A2C_reward_3_5M")
    ...
    model3.save(f"models/A2C_with_custom_rewards_3/{iters * TIME_STEPS}")
